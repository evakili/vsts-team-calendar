...
export interface IFreeFormEventDialogOptions extends IEventDialogOptions { 
    categories: IPromise<string[]>;
}

export interface ICapacityEventDialogOptions extends IEventDialogOptions {  
...
*/
export class EditEventDialog<TOptions extends IEventDialogOptions> extends Controls_Dialog.ModalDialogO<TOptions> {
    ...
    protected _createLayout() {
        ...
        this._eventValidationError = Controls.Control.create(Controls_Notifications.MessageAreaControl, this._$container, { closeable: false });
...
*/
export class EditFreeFormEventDialog<TOptions extends IFreeFormEventDialogOptions> extends EditEventDialog<TOptions> {
...
*/
export class EditCapacityEventDialog<TOptions extends ICapacityEventDialogOptions> extends EditEventDialog<TOptions> {
